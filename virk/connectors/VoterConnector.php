<?php
	class VoterConnector {
		...
		function __construct($mysqli) {
			...
			$this->selectStatement = $mysqli->prepare("SELECT * FROM " . VoterConnector::$TABLE_NAME . " WHERE `" . VoterConnector::$COLUMN_ID . "` = ?");
			$this->selectAllStatement = $mysqli->prepare("SELECT * FROM " . VoterConnector::$TABLE_NAME);
